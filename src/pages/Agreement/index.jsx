      ...
      <div className={style.agreeContainer}>
        ...
        <main>
          ...
          <section>
            ...
            <p>
              {t(
                '1. After the user successfully registers, Token 17 will provide each user with a user account. The user should keep the Token 17 account and password properly.'
              )}
              <br />
              {t(
                '2. During the use of Token 17 services, users shall bear full legal responsibility for any consequences arising from all activities and events conducted under their user accounts.'
              )}
              <br />
              {t(
                '3. Users need to provide Token 17 with true, legal and valid registration information. Token 17 will not be responsible for any related problems caused by untrue registration information or untimely updates. Users are not allowed to impersonate others, are not allowed to register maliciously, and are not allowed to buy, sell or transfer Token 17 accounts. Otherwise, Token 17 has the right to immediately stop providing services, withdraw their accounts and the users shall bear all legal responsibilities arising therefrom.'
              )}
              <br />{' '}
              {t(
                '4. Without the written permission of Token 17, no organization or individual may use any service or content of this platform for commercial purposes.'
              )}
              <br />
              {t(
                '5. The users use of Token 17 services and data directly or indirectly through various methods (such as API calls, etc.) will be deemed to have unconditionally accepted the entire content of this agreement. If the user has objections to any terms of this agreement, please stop Use all services provided by Token 17.'
              )}
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              {t(
                '1. The specific service content of Token 17 is provided by Token 17, including but not limited to information search, data query, data analysis, currency prices, data charts, news information, API plug-ins, etc. Token 17 has the right to provide services or Product form upgrades or other adjustments.'
              )}
              <br />
              {t(
                '2. Some of the network services provided by Token 17 are paid network services. Users need to pay a certain fee to Token 17 before using paid network services. For paid network services, Token 17 will give users clear prompts before using them. Only Only after the user confirms his willingness to pay the relevant fees according to the prompts can he use the charged network service. If the user refuses to pay the relevant fees, Token 17 has the right not to provide such paid network services to the user.'
              )}
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <br />
              {t(
                '2. Token 17 needs to regularly or irregularly inspect or maintain the Token 17 website or related equipment. If the service is interrupted within a reasonable time due to such circumstances, Token 17 does not need to bear any responsibility to any user or any third party. .'
              )}
              <br />{' '}
              {t(
          ...
          <section>
            ...
            <p>
              {t(
                'Token 17 is the owner and intellectual property owner of all services, content and products on the Token 17 platform. All services, content and products of the Token 17 platform include but are not limited to: program codes, data materials, page designs, accounts, pictures, charts, text, advertisements, trademarks, software, programs, audio, videos, etc. Without the written authorization or consent of Token 17 or the relevant rights holder, no media, website or individual may directly or indirectly publish, reproduce or otherwise use the above content. If authorized or agreed, it should be used within the scope of authorization or consent, and Indicate the source of data or services as Token 17.cc.'
              )}
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              {t(
                '1. Token 17 is not responsible for the authenticity, timeliness, accuracy, completeness or reliability of the content it provides, and does not guarantee the accuracy and completeness of external links set up to provide convenience to users. Token 17 does not assume any responsibility to the user or any third party for any loss caused by the direct or indirect use of the content of this website, and the resulting loss shall be borne independently by the user.'
              )}
              <br />{' '}
              {t(
                '2. Token 17 does not assume any responsibility for service interruptions or other defects caused by force majeure or other reasons beyond Token 17’s control.'
              )}
              <br />{' '}
              {t(
                '3. Users should abide by national laws, regulations and policies when using Token 17 services, and bear the consequences of their actions arising from their use of Token 17 services.'
              )}
            </p>
          </section>
